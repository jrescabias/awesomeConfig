...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ ctrl }, "b", function()
		awful.spawn.with_shell("bitwarden")
	end,
	{ description = "open bitwarden", group = "launcher" }),
	awful.key({ modkey, shift }, "v", function()
		awful.spawn.with_shell("vmware")
	end,
	{ description = "open vmware", group = "launcher" }),
